...
#define grisfonce            0x292929

// Couleurs persos qui seront principalement utilisées dans le projet

#define perso_grisclair      0xB6B6B6
#define perso_bleuclair      0x60A7FF
#define perso_gris           0x646464
#define perso_blancjaune     0xD6D79F
